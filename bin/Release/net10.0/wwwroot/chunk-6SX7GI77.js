import{b as c}from"./chunk-C3UEBIJJ.js";import{Cc as n,Da as a,cc as e,dc as t,ma as m,q as d,td as s,zb as l}from"./chunk-PTDLXWC4.js";import"./chunk-62QEBAUP.js";var w=(()=>{class i{zone=m(a);mermaidImport=m(c,{optional:!0});mermaid;isMermaid=!0;constructor(){this.isMermaid&&this.mermaidImport&&this.loadMermaid(this.mermaidImport)}ngAfterViewChecked(){this.isMermaid&&this.mermaid&&(this.isMermaid=!1,this.zone.runOutsideAngular(()=>this.mermaid?.default.run()))}loadMermaid(r){this.zone.runOutsideAngular(()=>d(r).pipe(s()).subscribe(o=>{this.mermaid=o,this.mermaid.default.initialize({startOnLoad:!1,forceLegacyMathML:!0}),this.mermaid?.default.run()}))}static \u0275fac=function(o){return new(o||i)};static \u0275cmp=l({type:i,selectors:[["app-menu1-2"]],decls:23,vars:0,consts:[[1,"normal-table-wrap"],[1,"sp-28"],[1,"sp-16"],[1,"mermaid"]],template:function(o,p){o&1&&(e(0,"div",0)(1,"h1",1),n(2,"Menu 1-2"),t(),e(3,"h1",2),n(4,"Example 1"),t(),e(5,"pre",3),n(6,`block-beta
columns 1
  db(("DB"))
